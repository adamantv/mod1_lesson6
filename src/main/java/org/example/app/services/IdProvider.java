...
public class IdProvider implements InitializingBean, DisposableBean, BeanPostProcessor {
    ...
    public void afterPropertiesSet() throws Exception {
        logger.info("provided afterPropirtiesSet invoked");
    }

    @Override
    public void destroy() throws Exception {
        logger.info("Disposeable bean destroy invoked");
    }
    ...
    public void postConstructIdProvider() {
        logger.info("PostConstructor annotated method called");
    }

    @PreDestroy
    public void preDestoryIdProvider() {
